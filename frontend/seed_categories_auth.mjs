...
async function seedCategoriesWithAuth() {
  console.log("====================================================");
  console.log("SEEDING CATEGORIES WITH AUTHENTICATED USER");
  console.log("====================================================");
  ...
  for (const cat of testCats) {
    ...
    if (error) {
      console.log(`Upsert error for '${cat.name}':`, error.message);
    } else {
